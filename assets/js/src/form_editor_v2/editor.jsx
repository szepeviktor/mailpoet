...
export const initBlocks = () => {
  ...
  registerBlockType(columns.name, Object.assign({}, columns.metadata, columns.settings));
  registerBlockType(column.name, Object.assign({}, column.metadata, column.settings));
};
